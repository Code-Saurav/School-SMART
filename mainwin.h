...
const std::string COMM_VERSION = "V0_1.2";
...
const std::string COOKIE = "«SmaArt»";     
...
class Mainwin : public Gtk::Window {
    ...
    protected:
        ...
        void set_grade_click();          //Set the grade
    ...
    private:
        ...
        std::vector<Transcript*> transcripts; // stores all Transcript istances.
